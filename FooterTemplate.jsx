    ...
    <footer className="bottom-0 left-0 w-full   text-white">
        ...
        <div className="container px-4 max-w-full">
            ...
            <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g transform="translate(0 -75)">
                        ...
                        <tspan x="654" y="518">Nathan@</tspan>
                        </text>
                    </g>
                    </g>
                </svg>
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
                <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-violet-600">Company</h2>
                </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto ">
                <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-violet-600">Blog</h2>
                </div>
                <ul className="leading-8">
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-violet-600">Connect With Us</h2>
                </div>
                <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-purple-600 hover:border-blue-400">
                ...
                <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-purple-600 hover:border-blue-400">
        ...
        <div className="bg-violet-700 py-4 text-gray-100 ">
        <div className="container mx-auto px-4">
            <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 w-full text-right">
                Copyright © {currentYear} <br></br>
                
                
            </div>
            <div className="px-4 w-full text-center mb-0">
                <span> Nathan´s  &trade; All Rights Reserved .</span> 
            </div>
            </div>
        </div>
        </div>
